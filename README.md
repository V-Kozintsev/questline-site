...
Зайти в лк бд 
```
mysql -u homestead -psecret -D questline
```

- Выбор базы данных (если не указано при подключении):
- Эта команда переключает текущую сессию на работу с базой questline.
...
Описание структуры конкретной таблицы, здесь пример с таблицей ideas:
